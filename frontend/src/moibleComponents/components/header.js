  ...
  return (
    <div>
       <nav className='bg-[#27374D] gap-[4vw] flex items-center justify-between  w-[100%]  pt-2 pb-1 px-10 '>
        ...
        <div className=' navlist md:static absolute bg-[#27374D] md:min-h-fit min-h-[100%] left-0 top-[-100%] w-full flex  items-top px-5  '>
        ...
        <div className='flex p-1 gap-[2vw]'>
            ...
            <input type="search" 
              class="peer cursor-pointer relative z-10 h-8 w-8 rounded-full border bg-transparent pl-12 outline-none focus:w-full 
      ...
      {toggle && (
        ...
        <ul className='flex md:flex-row flex-col item-:item-center md:gap-[4vw] gap-8 text-white'>
            ...
            <svg onClick={() => setToggle(!toggle)}  class="w-6 h-6 text-white dark:text-white pt-1 md:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 14">
